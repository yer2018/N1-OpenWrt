...
git clone https://github.com/jerrykuku/luci-app-argon-config.git clone/luci-app-argon-config
git clone https://github.com/jerrykuku/luci-theme-argon.git clone/luci-theme-argon
